...
\\ TOURANGEAU Sarah-Jeanne$_2$ (groupe 1) 
}
...
Nous avons choisi la méthode récursive. Un fois que le fichier est lu, voici les étapes de notre algorithme d'ordonnancement : \\
